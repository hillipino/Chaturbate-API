<?php
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Rows contain 12 Units (12u). For example at Desktop Resolution the default setting is (2u), which would equal 6 columns.
		// We get this number by dividing 12 by 2. Here are your options:
		...
		define ( 'COLUMNS_DESKTOP',	'2u' );										// How many columns do you want to show at Desktop Resolution.
		define ( 'COLUMNS_LARGE',	'3u(large)' );								// How many columns do you want to show on large Screens.
		define ( 'COLUMNS_TABLET',	'6u(medium)' );								// How many columns do you want to show on tablets.	
		define ( 'COLUMNS_MOBILE',	'12u(small)' );								// How many columns do you want to show on mobile devices.													
		...
		define ( 'THUMB_CNT',		24 );										// How many Thumbnails to show in the cam listings.
